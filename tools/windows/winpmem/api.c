...
NTSTATUS PmemGetProcAddresses() {
  ...
  //  };
  //};
	Pmem_KernelExports.MmGetPhysicalMemoryRanges = MmGetPhysicalMemoryRanges;
	Pmem_KernelExports.MmGetVirtualForPhysical = MmGetVirtualForPhysical;
	Pmem_KernelExports.MmMapIoSpace = (void*)MmMapIoSpace;
	Pmem_KernelExports.MmUnmapIoSpace = (void*)MmUnmapIoSpace;
